...
def cli_tcp_main():
    ...
    parser = argparse.ArgumentParser(
        ...
        usage=usage_str,
        description=(
            "Writes to a file the federal payroll tax "
    ...
    parser.add_argument(
        ...
        nargs="?",
        help=(
            "INPUT is name of CSV-formatted file that "
    ...
    parser.add_argument(
        "TAXYEAR",
        nargs="?",
        help=("TAXYEAR is calendar year for which taxes " "are computed."),
        type=int,
        default=0,
    )
    parser.add_argument(
        "--baseline",
        help=(
            "BASELINE is name of optional JSON reform file. "
    ...
    parser.add_argument(
        "--reform",
        help=(
            "REFORM is name of optional JSON reform file. "
    ...
    parser.add_argument(
        "--assump",
        help=(
            "ASSUMP is name of optional JSON economic "
    ...
    parser.add_argument(
        "--exact",
        help=(
            "optional flag that suppresses the smoothing of "
    ...
    parser.add_argument(
        "--tables",
        help=(
            "optional flag that causes distributional "
    ...
    parser.add_argument(
        "--graphs",
        help=(
            "optional flag that causes graphs to be written "
    ...
    parser.add_argument(
        "--dump",
        help=(
            "optional flag that causes OUTPUT to contain "
    ...
    parser.add_argument(
        "--dvars",
        help=(
            "DVARS is name of optional file containing a "
    ...
    parser.add_argument(
        "--sqldb",
        help=(
            "optional flag that writes SQLite database "
    ...
    parser.add_argument(
        "--outdir",
        help=(
            "OUTDIR is name of optional output directory "
    ...
    parser.add_argument(
        "--test",
        help=(
            "optional flag that conducts installation "
    ...
    parser.add_argument(
        "--version",
        help=(
            "optional flag that writes Taxcalc-Payroll "
...
def _compare_test_output_files():
    ...
    if "".join(explines) == "".join(actlines):
        ...
        diff = difflib.unified_diff(
            ...
            tofile=ACTUAL_TEST_OUTPUT_FILENAME,
            n=0,
        )
