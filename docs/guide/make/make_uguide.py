...
TAXCALCPAYROLL_PATH = os.path.join(CURDIR_PATH, "../../..", "taxcalcpayroll")

# INPUT_PATH = os.path.join(CURDIR_PATH, INPUT_FILENAME)
# Use TCJA to determine whether policies change in 2026.
TCJA_PATH = os.path.join(TAXCALCPAYROLL_PATH, "reforms/TCJA.json")
POLICY_PATH = os.path.join(TAXCALCPAYROLL_PATH, "policy_current_law.json")
IOVARS_PATH = os.path.join(TAXCALCPAYROLL_PATH, "records_variables.json")
CONSUMPTION_PATH = os.path.join(TAXCALCPAYROLL_PATH, "consumption.json")
GROWDIFF_PATH = os.path.join(TAXCALCPAYROLL_PATH, "growdiff.json")
...
def main():
    ...
    consumption_param_text = make_params.make_params(CONSUMPTION_PATH, "consumption")
    assumption_param_text = (
        "## Growdiff\n\n"
        + growdiff_param_text
        + "\n\n## Consumption\n\n"
